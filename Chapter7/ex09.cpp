...
Упражнение:
    Предложите три усовершенствования калькулятора (не упомянутых в главе). Реализуйте одно из них.

    Можно добавить функции вычисления синуса, косинуса и логарифма. Реализую функцию вычисления
    логарифма. 
*/
...
constexpr char logLex = 'l'; // Лексема log
const std::string logWord = "log"; // Ключевое слово log
...
void Calculate() // Цикл вычисления выражения
{
    ...
    try
    {
        ...
        else if (t.kind == help)
        {
            ...
            std::cout << "pow(a,b), где a - число, b - степень,\n";
            std::cout << "log(a,b), где a - основание, b - число,\n";
            std::cout << "sqrt(a), где a - число.\n";
...
int main()
{
    std::cout << "Добро пожаловать в программу-калькулятор! Чтобы увидеть справку, введите 'help'.\n";
    std::cout << "Пример выражения: 1+2*(3/4);. Для выхода введите 'quit'. \n";
    Calculate();
    return 0;
}
